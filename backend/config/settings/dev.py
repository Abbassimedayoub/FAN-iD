"""Local development settings for docker-compose."""
...
# Schema and Swagger UI are public in local development.
SPECTACULAR_SETTINGS = {**SPECTACULAR_SETTINGS, "SERVE_PUBLIC": True}  # noqa: F405

OTEL_TRACES_SAMPLE_RATE = 1.0  # 100% sampling in development
